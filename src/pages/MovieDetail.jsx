    ...
    return (
        <div className="vintage-frame">
            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-6 py-8 md:py-12">
                <button
                    onClick={() => navigate(-1)}
                    className="z-30 mb-6 md:mb-8 px-4 md:px-6 py-2 md:py-3 text-sm md:text-base font-display uppercase tracking-wider bg-gray-800 text-gray-400 hover:text-white transition-colors border-2 border-gray-900 inline-flex items-center gap-2"
                >
                    <span>←</span> Retour
                </button>
                ...
                {movie.similar && movie.similar.results.length > 0 && (
                    <section className="mb-12 md:mb-16">
                        <h2 className="text-3xl md:text-4xl font-display uppercase tracking-wider text-gray-600 mb-6 md:mb-8">
                            <span className="text-4xl md:text-5xl text-gray-800">F</span>ilms similaires
                        </h2>
                ...
                <section className="border-t-2 border-gray-800 pt-12">
                    ...
                    <form onSubmit={handleSubmitComment} className="mb-8">
                        ...
                        />
                        <div className="mb-4">
                            <label htmlFor="movie-comment-visibility" className="block mb-2 text-xs font-display uppercase tracking-wider text-gray-500">
                                Visibilite
                            </label>
                            <select
                                id="movie-comment-visibility"
